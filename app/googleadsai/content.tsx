...
import { Target, Zap, BarChart3, CheckCircle2, Search } from "lucide-react"
    ...
    >
      ...
      <section className="relative px-6 py-20 sm:py-28">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            {["Ad copy A/B testing", "Remarketing", "AI Scan included", "No contracts"].map((item, i) => (
      ...
      <section id="email-capture" className="relative px-6 py-20 sm:py-24">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-cyan-400 text-xs font-bold uppercase tracking-widest mb-3">Free Google Ads AI Scan</p>
          <h2 className="text-3xl sm:text-4xl font-black text-white mb-3 leading-tight">
            Find Out Exactly Where Your<br />Ad Budget Is Being Wasted
          </h2>
          <p className="text-gray-400 mb-8">
            A free Google Ads AI Scan that reveals the 6 mistakes draining most local Google Ads accounts — and exactly what to fix first.
          </p>
          <EmailCapture tag="google-ads-audit" ctaText="Get My Free AI Scan" accentClass="border-cyan-500/30 focus:border-cyan-500/60" btnClass="from-cyan-600 to-cyan-500" />
        </div>
      </section>
      ...
      <section className="relative px-6 py-24 sm:py-32">
        ...
        >
          ...
          <p className="text-gray-400 text-lg mb-10 max-w-xl mx-auto">
            Enter your email and we&apos;ll reach out to schedule a free Google Ads AI Scan — you&apos;ll see exactly where the budget is going and what we&apos;d do differently.
          </p>
          <a
            href="#email-capture"
          ...
          <p className="mt-4 text-xs text-gray-600">Active account required · No contracts</p>
        </motion.div>
      </section>
    </LandingLayout>
  )
